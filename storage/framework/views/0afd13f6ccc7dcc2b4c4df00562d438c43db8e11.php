        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="p-4">
              ...
              <form action="<?php echo e(route('register')); ?>" method="POST" class="user" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                    id="exampleFirstName" placeholder="Name" name="name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>"
                    name="email" id="email" placeholder="Email Address" value="<?php echo e(old('email')); ?>">
...
<?php /**PATH D:\Sistem-Informasi-Klinik\Sistem-Informasi-Klinik\resources\views/auth/register.blade.php ENDPATH**/ ?>