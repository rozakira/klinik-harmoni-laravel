...
unset($__errorArgs, $__bag); ?>" id="name" name="name"
              placeholder="Nama User" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" id="email" name="email"
              placeholder="Email User" value="<?php echo e(old('email')); ?>">
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Sistem-Informasi-Klinik\Sistem-Informasi-Klinik\resources\views/admin/pasien/create.blade.php ENDPATH**/ ?>